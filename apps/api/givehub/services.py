...
def to_opportunity_out(
    ...
    return OpportunityOut(
        ...
        time_commitment_minutes=item.time_commitment_minutes,
        training_required=item.training_required,
        training_commitment=item.training_commitment,
        screening_required=item.screening_required,
        screening_steps=item.screening_steps,
        transportation_info=item.transportation_info,
